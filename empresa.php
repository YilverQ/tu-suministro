...
<title>Tu Suministro, Empresa</title>
<!-- InstanceEndEditable -->
...
<div class="container"><!-- InstanceBeginEditable name="partesuperior" -->
  <?php include("includes/cabecera.php"); ?>
  <div class="header">
    <div class="clearfloat"></div>
    <?php include("includes/menu.php"); ?>
 </div>
    <?php include("includes/empresatop.php"); ?>
...
<br><h6>Valores</h6><br>
<p>&bull; Respeto.</li> 
<p>&bull; Trabajo en equipo.</li>
<p>&bull; Integridad y Honestidad.</p></li>
<br>
